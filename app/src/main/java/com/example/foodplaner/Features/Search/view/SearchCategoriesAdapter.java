...
public class SearchCategoriesAdapter extends RecyclerView.Adapter<SearchCategoriesAdapter.HomeViewHolder> {
    ...
    public SearchCategoriesAdapter(Context context, OnCategoryClickListener listener) {
